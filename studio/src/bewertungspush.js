...
export function createBewertungspush(){
 ...
 c.recipients=[
  {first_name:'Hannah',last_name:'Seidel',company:'Hotel Lindenhof',segment:'Hotels',salutation:'Guten Tag Frau Seidel,',personal_note:'Bevor Gäste bei Ihnen buchen, schauen sie auf Google. Unberechtigte Bewertungen können dabei den Eindruck von Ihrem Hotel verzerren. Lassen Sie uns prüfen, was sich ändern lässt.'},
  {first_name:'Marco',last_name:'Berg',company:'Restaurant Abendrot',segment:'Restaurants',salutation:'Guten Tag Herr Berg,',personal_note:'Ihr nächster Gast schaut vielleicht gerade auf Google. Unberechtigte Bewertungen sollten den Eindruck von Ihrem Restaurant nicht bestimmen. Wir prüfen, was sich ändern lässt.'},
  {first_name:'Julia',last_name:'Kern',company:'Werkstatt Kern',segment:'Werkstätten',salutation:'Guten Tag Frau Kern,',personal_note:'Wer eine Werkstatt sucht, sucht Vertrauen. Unberechtigte Bewertungen können den ersten Eindruck verzerren. Wir prüfen, welche Beiträge sich anfechten lassen.'}
