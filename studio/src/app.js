...
$('#csv-template').onclick=()=>download(new Blob([csvString([{company:'Muster GmbH',first_name:'Anna',salutation:'Hallo Anna,',website:'muster.example',chatbot_url:'https://chattastic.de/'}],keys())],{type:'text/csv;charset=utf-8'}),'kontaktstoff-empfaenger-vorlage.csv');
