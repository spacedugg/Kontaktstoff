...
**Meine Kreationen** zeigt eigene Projekte unter den drei Beispieldesigns. Gespeicherte Beispiele und frühere Tutorial-Entwürfe stehen separat im eingeklappten Bereich „Gespeicherte Beispiele“; die Suche öffnet passende Treffer dort automatisch. Eigene Projekte lassen sich suchen, duplizieren und löschen. Auch im geöffneten Entwurf ist „Kreation löschen“ verfügbar. Nach Bestätigung landet der Entwurf im Papierkorb der Übersicht und kann dort wiederhergestellt werden. Die Speicherung prüft innerhalb einer IndexedDB-Transaktion, dass verzögerte Speichervorgänge gelöschte Entwürfe nicht erneut aktivieren. Der Papierkorb bleibt ebenfalls nur in diesem Browser gespeichert.

**Einstieg:** Die Übersicht zeigt einen Hauptbutton „Eigene Kampagne starten“ und darunter drei kompakte **Beispieldesigns**. „Ansehen“ öffnet eine reduzierte Vorschau. „Dieses Design verwenden“ erstellt direkt eine unabhängige eigene Kopie ohne Beispielkontakte und öffnet deren Editor. In der Beispielvorschau sind Prüfung und Export eingeklappt; bei eigenen Kampagnen bleiben sie direkt sichtbar. Weitere Vorlagen sind darunter eingeklappt. Vorlagen sind native, vollständig bearbeitbare Elemente ohne Beispielkontakte. Die drei fertigen Fotokampagnen öffnen sich als unabhängige Beispiele mit fiktiven Empfängern in 3D. Über „Anderen Beispielkontakt ansehen“ wechseln die personalisierten Inhalte sichtbar mit. Das frühere Muster bleibt unter `?demo=1` verfügbar.
